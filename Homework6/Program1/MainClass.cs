    ...
    class MainClass {
        public static void Main() {
            try {
                ...
                Console.WriteLine("GetOrdersByPrice:'100'");
                orders = os.QueryByTotalGoodsPrice(100);
                foreach (Order od in orders)
                    Console.WriteLine(od.ToString());
                ...
                Console.WriteLine("================================================================================");
                Console.WriteLine("XmlSerializer orderService");
                os.Export("temp.xml");
                Console.WriteLine("Complete");
                Console.WriteLine("================================================================================");

                Console.WriteLine("XmlDeserializer orderService");
                os.Import("temp.xml");
                Console.WriteLine("Complete");
                Console.WriteLine("================================================================================");
                Console.WriteLine("GetAllOrders");
